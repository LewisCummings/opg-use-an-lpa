            ...
            new Csrf(
                ...
                [
                    'csrf_options' => [
                        'guard' => $csrfGuard,
                        'messageTemplates' => [
                            CsrfGuardValidator::NOT_SAME => "As you have not used this service for over 30 minutes, the page has timed out. We've now refreshed the page - please try to sign in again."
                        ],
                    ],
                ]
            )
